		...
		<section className="py-16 px-4 sm:px-6 lg:px-8 bg-white dark:bg-gray-900">
			<div className="max-w-6xl mx-auto">
				...
				<div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
					{/* Meer leefruimte */}
					<div className="bg-gradient-to-br from-[#ea5c33]/10 to-[#ea5c33]/5 dark:from-[#ea5c33]/20 dark:to-[#ea5c33]/10 rounded-2xl p-6 shadow-lg border border-[#ea5c33]/20 dark:border-[#ea5c33]/30 text-center">
				...
				<div className="mt-12 text-center">
					<div className="bg-gradient-to-r from-[#ea5c33]/10 to-[#ea5c33]/5 dark:from-[#ea5c33]/20 dark:to-[#ea5c33]/10 rounded-2xl p-8 shadow-lg border border-[#ea5c33]/20 dark:border-[#ea5c33]/30 max-w-4xl mx-auto">
						<Image 
